...
class FindsTab(TripFilterTreeTab):
    ...
    def new_find(self) -> None:
        ...
        FindFormDialog(
            ...
            locations_by_event,
            save_find,
            team_member_choices_by_event=self._team_member_choices_by_event(events),
    ...
    def edit_find(self) -> None:
        ...
        FindFormDialog(
            ...
            locations_by_event,
            save_find,
            team_member_choices_by_event=self._team_member_choices_by_event(events_for_choices),
