...
class LocationPickerDialog(tk.Toplevel):
    def __init__(
        ...
        ttk.Label(source_frame, text="Locations").pack(anchor="w", pady=(0, 2))
        ttk.Label(source_frame, text=f"Trip: {trip_name}").pack(anchor="w", pady=(0, 4))
